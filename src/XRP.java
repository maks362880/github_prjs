...
public class XRP {
    public static void main(String[] args) {
        //цель программы сформировать сетку для тейдинга на покупку и продажу XRPы исходя из ее исторических максимумов и минимумов
        //вводные данные, можно редактировать
        double money = 3747.94*2; // количество XRP для разбивки
        double max = 2;// максимальное значение цены XRPы
        double min = 0.511; //минимальное значение цены XRPы
        ...
        System.out.println("Общий объем средств равен " + money + " XRP");
        ...
        System.out.println("Средний шаг по объему средств " + stepmon + " XRP");
        int j = 0; // цикл
        for (double i = min; i <= max; i = i + step) {//финальный цикл сборки всех параметов
            int k = j + 1;
            itr[j] = i;
            mon[j] = stepmon * agrs[j] / summ;
            System.out.println("Объем " + mon[j] + " XRP линия сетки № " + k + " значение " + itr[j] + " долл.");
            j++;
        }
